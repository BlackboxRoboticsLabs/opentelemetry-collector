# Blackbox readiness adapter for open-telemetry/opentelemetry-collector

This fork contains a small Blackbox Robotics compatibility capsule for observability collection patterns for robot evidence.
